      ...
      <div className="overflow-x-auto h-full w-full relative z-10">
        <div className="flex">
          <div className="text-white lg:ml-28 ml-4 my-10">
            ...
            <p><span className="font-black text-xl FontFreeNetProximaNovaSoftW03">N alumnos ranking:</span> <span className="ProximaNovaSoftW03">315</span></p>
          </div>
        ...
        {slidersText.map((x, i) => (
          <div key={i} className="flex">
            ...
            <div className="w-3/12 lg:w-1/2 flex content-center items-center justify-center mt-10 text-white FontFreeNetProximaNovaSoftW03">0.44 pts</div>
          </div>
        ))}
      </div>
    </div>
